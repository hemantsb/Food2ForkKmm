package bit.hemant.kmmfood2fork.android.presentation.recipe_detail.components
        ...
        item {
            ...
            Column(
                ...
                for(ingredients in recipe.ingredients){
                    ...
                    Text(text = ingredients, modifier = Modifier.fillMaxWidth().padding(4.dp), style = MaterialTheme.typography.subtitle2)
                }
